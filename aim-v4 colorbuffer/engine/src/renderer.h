...
struct renderer {
  ...
  void render(game *game_inst);

  // cpu renderer
  //void init_cpu_renderer();
  //void set_draw_color(uint32_t color = 0);
  //void draw_rect(int x, int y, int w, int h, uint32_t color = 0);
  //void draw_point(int x, int y, uint32_t color = 0);
  void cpu_submit();
  // cpu renderer
