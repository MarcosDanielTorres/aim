...
void HelloTriangleApplication::initWindow(app_config app_config) {
        glfwInit();

        glfwWindowHint(GLFW_CLIENT_API, GLFW_NO_API);

        window = glfwCreateWindow(app_config.width, app_config.height, app_config.name, nullptr, nullptr);
